(window.webpackJsonp=window.webpackJsonp||[]).push([[9],{447:function(E,x,s){"use strict";s.r(x);var f=function(){var v=this,o=v.$createElement,i=v._self._c||o;return i("canvas",{ref:"canvas",staticClass:"canvas",attrs:{"aria-label":"landing background"}})},p=[],n=s(323),h=`#define GLSLIFY 1
